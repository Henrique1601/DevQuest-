...
> O DevQuest possui uma bateria de testes contínua composta por **76 testes automatizados** distribuídos em 20 arquivos de suíte executados pelo **Vitest**, garantindo que algoritmos, regras de negócio, dados e esquemas permaneçam 100% íntegros a cada commit.
...
### 8. Testes de Ranking, Ligas & Certificados (`src/__tests__/leaderboard.test.ts`, `certificate.test.ts`)
